...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    campaignImpactPoints: Schema.Attribute.Component<
      'shared.bullet-point',
      true
    > &
    ...
    clientType: Schema.Attribute.Enumeration<
      ['Executed', 'Reimagined', 'Conceptual']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    postEventMarketingPoints: Schema.Attribute.Component<
      'shared.marketing-group',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    preEventMarketingPoints: Schema.Attribute.Component<
      'shared.marketing-group',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
    ...
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'shared.bullet-point', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiWorkshopWorkshop extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Workshop / training session';
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatYouWillLearnPoints: Schema.Attribute.Component<
      'shared.bullet-point',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
